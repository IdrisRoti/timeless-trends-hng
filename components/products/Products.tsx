...
export default function Products({
  ...
  return (
    <div className="max-w-[1100px] mx-auto mt-11">
      <h2 className="text-2xl font-semibold mb-6 flex items-center gap-4">Page <div className="bg-black w-[2rem] text-white aspect-square rounded-full flex items-center justify-center">{Math.ceil(endIndex/ITEMS_PER_PAGE)}</div></h2>

      <section className="mb-12">
        <div className="grid grid-cols-2 md:grid-cols-4  gap-[1rem]">
          {productsData.slice(startIndex, endIndex).map((item, i) => (
